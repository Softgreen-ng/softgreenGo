    ...
    <div class="shadow p-3 px-4 bg-white my-1 mx-auto text-center rounded-20 bg-mobile" style="max-width:400px">
        ...
        <form @submit.prevent="login" class="mt-3 px-2  w-100 " _style="max-width:400px">
            <div class="mt-3 mb-2 ">
                ...
                <input v-model="user.email" placeholder="Example@email.com" type="email" class="_max-300 btn bg-white text-start form-control font-1 shadow py-3 px-4" required="true" />
            </div>
            ...
            <div class="mt-3 mb-2 ">
                ...
                <div class="btn text-start p-0 d-flex form-control font-1 shadow bg-white _max-300 ">
                    <input v-model="user.password" placeholder="********" :type="passconfType" class="btn border-0 shadow-none text-start form-control w-100 border-0 py-3 px-4 " required="true" />
                    <icon icon="ph:eye" width="25" class="my-auto me-3" v-if="passconfType == 'text'" @click="this.passconfType = 'password'" />
                    <icon icon="ph:eye-closed-fill" width="25" class="my-auto me-3" v-else @click="this.passconfType = 'text'" />
                </div>
